...
<div class="hb_mini_cart_item" data-cart-id="<?php echo esc_attr( $cart_id ); ?>">
	...
	<div class="hb_mini_cart_top">
		<h4 class="hb_title">
			<a href="<?php echo esc_url( get_permalink( $room->ID ) ); ?>"><?php printf( '%s', esc_html( apply_filters( 'hb_mini_cart_room_name', $room->name, $room->ID ) ) ); ?></a>
		</h4>
	...
	<div class="hb_mini_cart_price">
		...
		<span><?php echo wp_kses_post( hb_format_price( $cart_item->amount ) ); ?></span>
	</div>
