...
?>
<h2><?php esc_html_e( 'Finish', 'wp-hotel-booking' ); ?></h2>

<p><?php esc_html_e( 'WP Hotel Booking is ready to go!', 'wp-hotel-booking' ); ?></p>

<p class="finish-buttons">
	<a class="button" href="https://docspress.thimpress.com/wp-hotel-booking/" target="_blank">
		<?php esc_html_e( 'View Documentation', 'wp-hotel-booking' ); ?>
	</a>

	<a class="button" href="<?php echo esc_url_raw( admin_url( 'edit.php?post_type=hb_room' ) ); ?>">
		<?php esc_html_e( 'Back to Dashboard', 'wp-hotel-booking' ); ?>
	</a>
</p>
