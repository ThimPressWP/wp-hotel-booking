...
(function ($) {
	...
	$(document).ready(function () {
		...
		$('#multidate').daterangepicker({
			parentEl : ".multidate-layout .hb-form-table",
			minDate  : date_min,
			autoclose: true,
			autoApply: true
		});
		...
		$('#multidate').on('apply.daterangepicker', function (ev, picker) {
			...
			$('.multidate-layout input[id^="check_in_date"]').val(picker.startDate.format('MMMM DD, YYYY'));
			$('.multidate-layout input[id^="check_out_date"]').val(picker.endDate.format('MMMM DD, YYYY'));
			widthDay();
		});
