    ...
    Hotel_Booking_Order = {
        init: function () {
            ...
            // add coupon
                ...
                // change qty
                .on('change', '.hb_modal .booking-room-item .section select[name="qty"]', _self.update_item)
                // change field value
                .on('change keyup', '.hb_modal .booking-room-item .hb-room-item-field', _self.update_item)
