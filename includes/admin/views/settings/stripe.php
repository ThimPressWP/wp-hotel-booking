...
<table class="form-table">
    ...
    <tr>
        <th><?php _e( 'Test Mode Enable', 'tp-hotel-booking' );?></th>
        <td>
            <input type="hidden" name="<?php echo $field_name;?>[test_mode]" value="off" />
            <input type="checkbox" name="<?php echo $field_name;?>[test_mode]" <?php checked( $stripe['test_mode'] == 'on' ? 1 : 0, 1 ); ?> value="on" />
        </td>
    </tr>
    <tr>
        <th><?php _e( 'Test Secret Key', 'tp-hotel-booking' );?></th>
        <td>
            <input type="text" name="<?php echo $field_name;?>[test_secret_key]" value="<?php echo esc_attr( $stripe['test_secret_key'] ); ?>" />
        </td>
    </tr>
    <tr>
        <th><?php _e( 'Test Publishable Key', 'tp-hotel-booking' );?></th>
        <td>
            <input type="text" name="<?php echo $field_name;?>[test_publish_key]" value="<?php echo esc_attr( $stripe['test_publish_key'] ); ?>" />
        </td>
    </tr>
    <tr>
