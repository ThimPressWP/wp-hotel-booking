 ...
 * @Last Modified time: 2016-04-05 10:36:04
 */
				...
				<li>
					...
					<select name="_hb_method">
						<?php if ( ! array_key_exists( $booking->method, $methods ) ) : ?>
							<option value="<?php echo esc_attr( $booking->method ) ?>" selected><?php printf( __( '%s is not avaiable', 'tp-hotel-booking' ), $booking->method_title ) ?></option>
						<?php endif; ?>
		...
		<div class="section">
			...
			<div class="customer_details">
				...
				<div class="edit_details">
					<div class="edit_col">
						<?php hb_dropdown_titles( array( 'name' => '_hb_customer_title', 'selected' => $booking->customer_title ) ); ?>
					...
					<div class="edit_col">
						...
						<?php hb_dropdown_countries( array( 'name' => '_hb_customer_country', 'show_option_none' => __( 'Country', 'tp-hotel-booking' ), 'selected' => $booking->customer_country ) ); ?>
					</div>
				</div>
			</div>
