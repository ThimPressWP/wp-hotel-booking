		...
		<?php if ( ! empty( $external_links ) ): ?>
			<?php foreach ( $external_links as $link ): ?>
				<tr class="wphb-single-external-link">
					...
					<td>
						<img src="<?php echo esc_url( $link['icon_url'] ); ?>" size="50" class="wphb-select-link-icon" alt="<?php esc_attr_e( 'Choose logo', 'wp-hotel-booking' ); ?>" title="<?php esc_attr_e( 'Choose logo', 'wp-hotel-booking' ); ?>"/>
