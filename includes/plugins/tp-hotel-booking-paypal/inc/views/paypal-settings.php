...
<table class="form-table">
    <tr>
        <th><?php _e( 'Enable', 'tp-hotel-booking-paypal' ); ?></th>
        <td>
    ...
    <tr>
        <th><?php _e( 'Paypal sandbox email', 'tp-hotel-booking-paypal' ); ?></th>
        <td>
