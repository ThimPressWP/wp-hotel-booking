...
<tr class="hb_checkout_item package" data-cart-id="<?php echo esc_attr( $cart_id ) ?>" data-parent-id="<?php echo esc_attr( $parent_id ) ?>">

	<td colspan="<?php echo is_hb_cart() ? 2 : 1 ?>">
		<?php if( is_hb_cart() ): ?>
			<a href="#" class="hb_package_remove" data-cart-id="<?php echo esc_attr( $cart_id ) ?>" data-parent-id="<?php echo esc_attr( $parent_id ) ?>"><i class="fa fa-times"></i></a>
		<?php endif; ?>
	</td>
