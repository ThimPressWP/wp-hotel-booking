...
<script type="text/html" id="tmpl-hb-room-load-form">
    ...
    <form action="POST" name="hb-search-single-room" class="hb-search-room-results hotel-booking-search hotel-booking-single-room-action">
        ...
        <div class="hb-booking-room-form-head">
            ...
            <p class="description"><?php _e( 'Please set arrival date and departure date before check available.', 'tp-hotel-booking-room' ); ?></p>
        </div>

        <div class="hb-search-results-form-container">
            <div class="hb-booking-room-form-group">
                <div class="hb-booking-room-form-field hb-form-field-input">
                    <input type="text" name="check_in_date" value="{{ data.check_in_date }}" placeholder="<?php _e( 'Arrival Date', 'tp-hotel-booking-room' ); ?>" />
                </div>
            </div>
            <div class="hb-booking-room-form-group">
                <div class="hb-booking-room-form-field hb-form-field-input">
                    <input type="text" name="check_out_date" value="{{ data.check_out_date }}" placeholder="<?php _e( 'Departure Date', 'tp-hotel-booking-room' ); ?>" />
                </div>
            </div>
            <div class="hb-booking-room-form-group">
                ...
                <button type="submit" class="hb_button"><?php _e( 'Check Available', 'tp-hotel-booking-room' ); ?></button>
            </div>
        </div>
    </form>
