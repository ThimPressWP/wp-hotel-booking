...
<table class="form-table">
    <tr>
        <th><?php _e( 'Enable', 'wp-hotel-booking-paypal' ); ?></th>
        <td>
    ...
    <tr>
        <th><?php _e( 'Paypal sandbox email', 'wp-hotel-booking-paypal' ); ?></th>
        <td>
