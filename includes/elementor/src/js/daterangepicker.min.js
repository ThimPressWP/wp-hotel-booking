...
(function ($) {
	"use strict";
	function widthDay() {
		$('.multidate-layout input.day').each(function () {
			var text = $(this).val() + 1;
	...
	if (typeof (hotel_settings) === 'undefined') {
		...
		$(window).on('load', function () {
			$('.multidate-layout input[id^="check_in_date"]').datepicker("option", {
				altField : $('.multidate-layout input[id^="check_in_date"]').parent().find('.day'),
				altFormat: "dd",
			});
			$('.multidate-layout input[id^="check_out_date"]').datepicker("option", {
				altField : $('.multidate-layout input[id^="check_out_date"]').parent().find('.day'),
				altFormat: "dd",
			});
			widthDay();
		})
	...
	$(document).ready(function () {
		...
		$('#multidate').daterangepicker({
			parentEl : ".hotel-booking-search-el .hb-form-table",
			minDate  : date_min,
			autoclose: true,
			autoApply: true
		});
		...
		$('#multidate').on('apply.daterangepicker', function (ev, picker) {
			...
			$('.hotel-booking-search-el input[id^="check_in_date"]').val(picker.startDate.format('MMMM DD, YYYY'));
			$('.hotel-booking-search-el input[id^="check_out_date"]').val(picker.endDate.format('MMMM DD, YYYY'));
			widthDay();
		});
