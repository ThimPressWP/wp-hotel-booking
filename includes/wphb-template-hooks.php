...
add_action( 'hb_before_search_result', 'wphb_enqueue_lightbox_assets' );
add_action( 'hb_lightbox_assets_lightbox2', 'wphb_lightbox_assets_lightbox2' );
add_action( 'hb_lightbox_assets_fancyBox', 'wphb_lightbox_assets_fancyBox' );
