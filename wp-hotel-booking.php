	...
	public function enqueue_assets() {
		...
		if ( is_admin() ) {
			...
			if ( WPHB_DEBUG ) {
				...
				wp_register_script( 'wp-admin-hotel-booking', $this->plugin_url( 'assets/js/admin/admin.hotel-booking.min.js' ), array_merge( $dependencies, array( 'wphb-dropdown-pages' ) ), WPHB_VERSION );
			}
